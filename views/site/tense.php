...
?>
    ...
    <table class="table-tense">
        <tr>
            <td align="center">Формы\Времена</th>
            <th>Present</th>
            <th>Past</th>
            <th>Future</th>
        ...
        <tr>
            ...
            <td align="center"><p class="color-text">Do/does <br/> Don't + do/doesn't + doing</p><br/>
                I go / don't go<br/>
                He/She goes / doesn't go <br/>
                We/You/They go / don't go
            </td>
            <td align="center"><p class="color-text">Did <br/> Didn't</p><br/>
                I went / didn't go<br/>
                He/She went / didn't go <br/>
                We/You/They went / didn't go
            </td>
            <td align="center"><p class="color-text">Will/Shall + do <br/> Won't/Shan't + do</p><br/>
            ...
            <td align="center"><p class="color-text">Would/should + do<br/> Wouldn't/shouldn't</p><br/>
        ...
        <tr>
            ...
            <td align="center"><p class="color-text">Am/is/are + doing <br> 'm not/isn't/aren't + doing</p><br/>
                I am going<br/>
                He/She is going <br/>
                We/You/They are going
            </td>
            <td align="center"><p class="color-text">Was/Were + doing <br> Wasn't/weren't + doing</p><br/>
                I was going<br/>
                He/She was going <br/>
                We/You/They were going
            </td>
            <td align="center"><p class="color-text">Will/shall + be doing</p><br/>
                I shall(will) be going<br/>
                He/She will be going <br/>
                We/You/They shall(will) be going
            </td>
            <td align="center"><p class="color-text">Would/should + been doing</p><br/>
        ...
        <tr>
            ...
            <td align="center"><p class="color-text">Have/has + done (III форма)</p><br/>
                I have gone<br/>
                He/She has gone <br/>
                We/You/They have gone
            </td>
            <td align="center"><p class="color-text">Had + done (III форма) </p><br/>
                I had gone <br/>
                He/She had gone <br/>
                We/You/They had gone
            </td>
            <td align="center"><p class="color-text">Will/Shall + have + done (III форма)</p><br/>
                I shall(will) have gone <br/>
                He/She will have gone <br/>
                We/You/They shall(will) have gone
            </td>
            <td align="center"><p class="color-text">Would/should + have + done (III форма)</p><br/>
        ...
        <tr>
            ...
            <td align="center"><p class="color-text">Have/has + been doing</p><br/>
                I have been going<br/>
                He/She has been going <br/>
                We/You/They have been going<br/>
            </td>
            <td align="center"><p class="color-text">Had + been doing</p><br/>
                I had been going <br/>
                He/She had been going <br/>
                We/You/They had been going
            </td>
            <td align="center"><p class="color-text">Will/Shall + have + been doing</p><br/>
                I shall(will) have been going <br/>
                He/She will have been going <br/>
                We/You/They shall(will) have been going
            </td>
            <td align="center"><p class="color-text">Would/should + have + been doing</p><br/>
